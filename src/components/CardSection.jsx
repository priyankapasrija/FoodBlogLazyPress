          ...
          <div className="mt-3 mb-3  ">
            <SearchBox
              ...
              classNames={{
                ...
                input:
                  "border border-black p-1 placeholder:text-slate-400 items-center flex font-sans text-sm w-[13vw] xs:hidden sm:hidden md:hidden lg:flex ",
                submit: "fill-white",
                submitIcon:
          ...
          >
            <div className="hidden sm:none md:none lg:flex lg:flex-col md:w-1/5 ml-8 px-1 bg-white border-1 border-black">
              <h4
                ...
                style={{ fontFamily: "Montserrat", fontSize: "0.7rem" }}
              >
                Region:
              </h4>
